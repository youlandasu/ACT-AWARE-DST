...
def process(file_path, is_training=False):
    ...
    for dialog in data_json:
        ...
        for i, turn_info in enumerate(dialog["dialogue"]):
            ...
            cur_turn_ds = fix_general_label_error(turn_info["belief_state"], False)
            cur_turn["system_acts"]  = turn_info["system_acts"]
            #print(cur_turn_act)
            #break
            cur_turn["belief_state"] = bs_format(cur_turn_ds)
