local train_data_path = "./data/train_act.json";
local validation_data_path = "./data/dev_act.json";
...
local num_use_val = 21; # number of values that uses value list
local dropout = 0.5;
...
local loss_weight = 2.0; # config distribution of loss for training calss+loss_weight/2*(span type+span)
{
    "dataset_reader": {
        "type": "act_aware_dst",
        "lazy": false,
    ...
    "model": {
        ...
        "phrase_layer": 
          if phrase_layer_type == "gru" then {
            ...
            "hidden_dim": base_dim,
            "projection_dim": base_dim,
            "feedforward_hidden_dim": base_dim,
